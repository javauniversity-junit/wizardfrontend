...
public class WizardController {
	...
	public String add(@RequestParam String name) throws SQLException {
		...
		wizard.setName(name);
		wizard.setAgentid(agent.getAgentid());
	...
	public String getAll(Model model) {
		...
		Iterable<Wizard> wizards = wizardRepository.findByAgentid(contact.getContactId(), sort);
