...
public class ConfidentialClientEvaluationOnePageController {
	...
	public String save(@RequestParam String wizardId, @RequestParam String wizarddataid,
			...
			@RequestParam String lastYearValue1, @RequestParam String lastYearValue2,
			@RequestParam String lastYearValue3, @RequestParam String lastYearValue4,
			@RequestParam String lastYearValue5, @RequestParam String lastYearValue6,
			@RequestParam String totalMediaInvestment, @RequestParam String pctTAIGrossSalesLastYear,
			@RequestParam String grossSalesLastyear, @RequestParam String nextPage, @RequestParam String publishPage,
			@RequestParam String previousPage, @RequestParam(required = false, value = "previous") String previous,
