...
public class ConfidentialClientEvaluationOnePageController {
	...
	public String detail(Model model, @RequestParam String ID) {
		...
		WizardData wizardData = wizardDataRepository.findByPagesequenceAndWizardid(Pages.ConfidentialClientEvaluationOnePage.getPageSequence(), wizard.getWizardid());
		ConfidentialClientEvaluationOnePageModel dataPageModel = null;
		if (wizardData != null) {
			dataPageModel =(ConfidentialClientEvaluationOnePageModel)JSONManager.convertFromJson(wizardData.getPagedata(), ConfidentialClientEvaluationOnePageModel.class);
	...
	public String save(@RequestParam String wizardId
		...
		ConfidentialClientEvaluationOnePageModel pageModel  = new  ConfidentialClientEvaluationOnePageModel(lastYearLabel1, lastYearLabel2, lastYearLabel3,
				...
				lastYearValue6, totalMediaInvestment, pctTAIGrossSalesLastYear,
				grossSalesLastyear);
