...
public class PlanALifetimeValuedPageModel {
	...
	public PlanALifetimeValuedPageModel(String averageSale, String grossProfitMargin,
			String averageRepeatSales,
			String yearsOfPatronage, String grossProfitPerSale,
			String averageCustomerValue,
			String lifetimeValuePerCustomer, String monthlyInvestmentAverage
			, String prospectsNeededToBreakEven) {
		super();
